                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5  w3-theme-l4">
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <form method="post" action="{{ url('store19') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="row text-center">
                                            <h2 class="mt-5 mb-3">บทความชวนคิด ให้ใจได้เปลี่ยน</h2>
                                            <div class="my-custom-scrollbar my-custom-scrollbar-primary mx-auto mt-5 mb-3">
                                                <img class="mySlides1" src="images/day19/นิทาน/1.png" style="width:100%">
                                                <img class="mySlides1" src="images/day19/นิทาน/2.png" style="width:100%">
                                                <img class="mySlides1" src="images/day19/นิทาน/3.png" style="width:100%">
                                            </div>
                                        </div>
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="my-custom-scrollbar my-custom-scrollbar-primary mx-auto mt-5 mb-3">
                                            <img class="mySlides1" src="images/day19/1.png" style="width:100%">
                                            <img class="mySlides1" src="images/day19/2.png" style="width:100%">
                                            <img class="mySlides1" src="images/day19/3.png" style="width:100%">
                                        </div>

                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5  w3-theme-l4">
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <form method="post" action="{{ url('store7') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <h2 class="mt-5 mb-3">ถ้าฉัน คิดแบบนี้ ฉันจะรู้สึก?</h2>
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="row text-center">
                                            <h2 class="mt-5 mb-3">มุมมองความรู้</h2>
                                            <div class="my-custom-scrollbar my-custom-scrollbar-primary mx-auto py-3">
                                                <video class="mySlides1" autoplay muted loop="true">
                                                    <source src="images/day7/1.mp4" type="video/mp4">
                                                </video>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="my-custom-scrollbar my-custom-scrollbar-primary mx-auto py-3">
                                                <video class="mySlides1" autoplay muted loop="true">
                                                    <source src="images/day7/2.mp4" type="video/mp4">
                                                </video>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mySlides">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="my-custom-scrollbar my-custom-scrollbar-primary mx-auto py-3">
                                                <video class="mySlides1" autoplay muted loop="true">
                                                    <source src="images/day7/3.mp4" type="video/mp4">
                                                </video>
                                            </div>
                                        </div>

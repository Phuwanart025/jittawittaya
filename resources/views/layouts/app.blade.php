...
<head>
    ...
    <!-- owl stylesheets -->
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.15.3/css/all.css" integrity="xxxxxx"
                                        ...
                                        <div class="menu_main">
                                            ...
                                            <div class="padding_left0">
                                                @auth
                                                    ...
                                                    <a class="w3-btn w3-round-xlarge w3-hover-white"
                                                        href="{{ route('logout') }}"
                                                        onclick="event.preventDefault(); document.getElem                            entById('logout-form').submit();">ออกจากระบบ</a>
                                    ...
                                    <div class="overlay-content ">
                                        <div class="container">
                                            @auth
                                                ...
                                                <a class="w3-btn w3-round-xlarge w3-hover-white"
                                                    href="{{ url('/profile') }}"> <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <a class="w3-btn w3-round-xlarge w3-hover-white"
                                                    href="{{ url('/') }}"> หน้าแรก</a>
                                                <a class="w3-btn w3-round-xlarge w3-hover-white"
                                                    href="{{ url('choose') }}"> คู่มือการใช้งานระบบ</a>
                                                <a class=" w3-btn w3-round-xlarge w3-hover-white"
                                                    href="{{ url('Menu_day') }}"> บันทึกของฉัน</a>
                                                <a class=" w3-btn w3-round-xlarge w3-hover-white"
                                                    href="{{ url('record') }}"> ประวัติบันทึกของฉัน</a>
                                                {{-- <a class="w3-btn w3-round-xlarge w3-hover-white"

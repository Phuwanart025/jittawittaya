...
<body>
    <div class="img-bg">
        <div class="header">
            <img align="left" src="images/rethink.jpg" class="img-thumbnail " alt="..." width="250"
                height="130">
            <h3 align="right">ประวัติบันทึกความรู้สึก</h3>
            <h3 align="right">คุณ: {{ Auth::user()->name }}</h3>
        </div>
        <br>
        <hr>
